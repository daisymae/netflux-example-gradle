...
public class Java8StreamExamples {
    ...
    public void parallelStreamExample() throws Exception {
        // use caution with parallel; do performance benchmarking
        List<String> dogs = Arrays.asList("Vizsla", "Lab", "Golden", "GSP", "Poodle", "Yorkie", "Mutt");
        dogs.parallelStream()
                .forEach(System.out::println);
    }
    ...
    public void mapStreamExample() throws Exception {
        List<String> dogs = Arrays.asList("Vizsla", "Lab", "Golden", "GSP", "Poodle", "Yorkie", "Mutt");
        dogs.stream()
                .map(String::length) // converts the type
                .forEach(System.out::println);
    }
    ...
    @Test
    public void filgerAndSortStreamWithFunctionalComp() throws Exception {
        List<String> dogs = Arrays.asList("Vizsla", "Lab", "Golden", "GSP", "Poodle", "Yorkie", "Mutt");
        String dogString = dogs.stream()
                .filter(s -> s.length() == 6)
                .limit(3)
    ...
    public void testGroupingBy() throws Exception {
        List<String> dogs = Arrays.asList("Vizsla", "Lab", "Golden", "GSP", "Poodle", "Yorkie", "Mutt");
        // groups the values by their length
    ...
    public void testFlatMap() throws Exception {
        ...
        // note on flatmap: may be getting more elements on the other end
    ...
    public void testReduction() throws Exception {
        ...
        // reduce is terminal and will return an Optional
